...
class FileTransferApp(wx.Frame):
    ...
    def set_client_controls_enabled(self, enabled=True):
        ...
        status_text = "Ready" if enabled else "Transfer in progress..."
    ...
    def refresh_list_worker(self):
        ...
        try:
            ...
            wx.CallAfter(self.SetStatusText, "Failed to refresh list.")
        finally:
    ...
    def upload_file_worker(self, filepath):
        ...
        try:
            ...
            wx.CallAfter(self.SetStatusText, "Upload error.")
        finally:
    ...
    def download_file_worker(self, filename):
        ...
        try:
            ...
            wx.CallAfter(self.SetStatusText, "Download error.")
        finally:
            self.update_progress(0, False);
            wx.CallAfter(self.set_client_controls_enabled, True)
